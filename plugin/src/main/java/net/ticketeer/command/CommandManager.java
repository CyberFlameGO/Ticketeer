...
import net.ticketeer.command.exception.CommandException;
import net.ticketeer.command.exception.CommandUsageException;
import net.ticketeer.command.exception.NoPermissionsException;
import net.ticketeer.command.exception.ServerCommandException;
import net.ticketeer.command.exception.UnhandledCommandException;
import net.ticketeer.command.exception.WrappedCommandException;
import net.ticketeer.util.Messaging;
import net.ticketeer.util.Paginator;
...
public class CommandManager {
    ...
    public boolean suggestClosestModifier(CommandSender sender, String command, String modifier) {
        String closest = getClosestCommandModifier(command, modifier);
        if (!closest.isEmpty()) {
            sender.sendMessage(ChatColor.GRAY + Messaging.tr(CommandMessages.UNKNOWN_COMMAND));
            sender.sendMessage(ChatColor.YELLOW + (" /") + ChatColor.GREEN + command + " " + ChatColor.GREEN + closest);
            return true;
        }
        return false;
    }
